  ...
  // ─── 16. EXTREME GAINZ ────────────────────────────────────────────────────
  {
    ...
    branches: [
      ...
      },
      {
        ...
        details: ["Open: Monday–Sunday, 6:00 AM – 12:00 AM"],
      },
      {
        name: "Dasma Bayan, Dasmariñas Cavite",
        address: "2nd Floor, Don P. Campos Avenue, Brgy. San Jose, Dasmariñas City, Cavite",
        details: ["Zumba classes available", "Open: 24 Hours"],
      },
    ],
    purchaseMethods: [
      {
